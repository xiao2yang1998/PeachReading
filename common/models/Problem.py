...
class Problem(db.Model):
    ...
    pro_id = db.Column(db.String(15), primary_key=True)
    ...
    scourse_id = db.Column(db.String(15), nullable=False, server_default=db.FetchedValue())
    pcourse_id = db.Column(db.String(15), nullable=False, server_default=db.FetchedValue())
    pro_num = db.Column(db.String(15), nullable=False, server_default=db.FetchedValue())
